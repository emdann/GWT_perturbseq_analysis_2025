...
# Directories
ITERATION_DIR=/oak/stanford/groups/pritch/users/rgoto/data/GWT_causal_gene_discovery/CD4i/burden_reg_corr/${TRAIT}/sign_permutation_iterations
FINAL_OUTDIR=/oak/stanford/groups/pritch/users/rgoto/data/GWT_causal_gene_discovery/CD4i/burden_reg_corr/${TRAIT}/sign_permutation_results
...
JOB_ID=$(sbatch \
    ...
    --wrap="python /oak/stanford/groups/pritch/users/rgoto/bin/GWT_causal_gene_discovery/src/5_reg_burden_correlation/sign_freedman_lane_single_iter.py \
